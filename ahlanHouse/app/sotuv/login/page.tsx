...
const DEMO_PHONE = process.env.NEXT_PUBLIC_SOTUV_DEMO_PHONE || "";
const DEMO_PASSWORD = process.env.NEXT_PUBLIC_SOTUV_DEMO_PASSWORD || "";
const HAS_DEMO = Boolean(DEMO_PHONE && DEMO_PASSWORD);
...
export default function SotuvLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast({
        title: "Xatolik",
        description: error instanceof Error ? error.message : "Kirishda xatolik",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
